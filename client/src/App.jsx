...
const AppLayout = ({ role, setRole }) => {
  ...
  return (
    <div className="p-4 text-center text-white">
      <header
        className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 p-4 bg-center text-sky-200 rounded-2xl slide-top gap-4"
      ...
      >
        ...
        {user && (
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4 w-full md:w-auto">
            <div className="text-sm text-left md:text-right flex-1">
            ...
            <button
              ...
              className="bg-red-500 text-white px-4 py-2 rounded self-end md:self-auto"
            >
              Logout
            </button>
          </div>
